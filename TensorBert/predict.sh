...
/home/zenith-kaju/miniconda3/envs/projenv/bin/python3.6 /home/zenith-kaju/NLP---Hyperpartisan-News-Detection/TensorBert/semeval-pan-2019-random-baseline.py --inputDataset=$INPUTDIR --outputDir=$OUTDIR