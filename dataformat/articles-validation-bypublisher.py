...
file = '../data/articles-validation-bypublisher-20181122/articles-validation-bypublisher-20181122.xml'
tree = ElementTree.parse(file)
root = tree.getroot()
tree_T = ElementTree.parse('../data/ground-truth-validation-bypublisher-20181122/ground-truth-validation-bypublisher-20181122.xml')
...
for article in root.iter('article'):
    ...
    with open('articles-validation-bypublisher.json', 'a', encoding='utf-8') as f:
